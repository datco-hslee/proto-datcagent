...
export function ERPDataManagementPage() {
  ...
  const erpStats = {
    ...
    totalRevenue: customers.reduce((sum, customer) => sum + (customer.totalOrders || 0) * 50000, 0),
            ...
            <div key={customer.id} style={{ 
              ...
              <div>
                ...
                <p style={{ fontSize: "0.875rem", color: "#6b7280" }}>
                  최근 주문: {new Date().toLocaleDateString('ko-KR')}
                </p>
              </div>
              <div style={{ textAlign: "right" }}>
                <p style={{ fontWeight: 500, color: "#111827" }}>₩{((customer.totalOrders || 0) * 50000).toLocaleString()}</p>
                <span style={{
                  padding: "0.25rem 0.5rem",
                  borderRadius: "0.25rem",
                  fontSize: "0.75rem",
                  fontWeight: 500,
                  backgroundColor: customer.status === '활성' ? "#dcfce7" : "#fef3c7",
                  color: customer.status === '활성' ? "#166534" : "#92400e"
                }}>
                  {customer.status}
                </span>
              </div>
